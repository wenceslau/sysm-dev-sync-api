...
public class ProjectIntegrationTest extends AbstractIntegrationTest {
    ...
    void setUp() {
        ...
        Workspace ws1 = Workspace.create("Workspace One", "Description one", false, owner.getId());
        workspace1 = WorkspaceJpaEntity.fromModel(ws1);
        workspaceJpaRepository.save(workspace1);

        Workspace ws2 = Workspace.create("Workspace Two", "Description two", true, owner.getId());
